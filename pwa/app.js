...
async function submitReport(){
  ...
  try{
    ...
    const payload={
      ...
      frekuensiKembali:$("frekuensiKembali").value.trim(), fileName:selectedPhoto.name,
      mimeType:selectedPhoto.type||"image/jpeg", fileBase64:base64
    };
    ...
    setTimeout(()=>{ window.location.href="briport://run?jobId="+encodeURIComponent(jobId); },500);
